...
var SlimScrollDirective = (function () {
    function SlimScrollDirective(viewContainer, renderer, document) {
        ...
        this.interactionSubscriptions = new Subscription_1.Subscription();
        this.initWheel = function () {
            ...
            var wheelSubscription = Observable_1.Observable.merge.apply(Observable_1.Observable, [dommousescroll, mousewheel]).subscribe(function (e) {
                var delta = 0;
                if (e.wheelDelta) {
        ...
        this.initDrag = function () {
            var bar = _this.bar;
            var mousemove = Observable_1.Observable.fromEvent(_this.document.documentElement, 'mousemove');
            var touchmove = Observable_1.Observable.fromEvent(_this.document.documentElement, 'touchmove');
            ...
            var mouseup = Observable_1.Observable.fromEvent(_this.document.documentElement, 'mouseup');
            var touchend = Observable_1.Observable.fromEvent(_this.document.documentElement, 'touchend');
            ...
            var dragSubscription = Observable_1.Observable.merge.apply(Observable_1.Observable, [mousedrag, touchdrag]).subscribe(function (top) {
            ...
            var dragEndSubscription = Observable_1.Observable.merge.apply(Observable_1.Observable, [mouseup, touchend]).subscribe(function () {
